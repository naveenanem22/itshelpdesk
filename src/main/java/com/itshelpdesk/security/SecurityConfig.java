	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			...
			.and()
				...
				.antMatchers("/v0/ticket-management/**").hasAnyRole("MANAGER", "ENGINEER", "EMPLOYEE")
				.antMatchers("/v0/ticket-support/**").hasAnyRole("MANAGER", "ENGINEER", "EMPLOYEE")
				.antMatchers("/v0/ticketing/**").hasAnyRole("MANAGER", "ENGINEER", "EMPLOYEE")
